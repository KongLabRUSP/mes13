...
# | Script: RNA-seq SD estimate using difference vs. mean, HG vs. MIC_1_5_uM only    |
...
plot(dt2$diff ~ dt2$mu,
     ...
     main = "MES13 RNA-Seq: HG vs. MIC_1_5_uM")
graphics.off()
...
plot(dt2$diff ~ dt2$mu,
     xlab = "Mean of Log2(Expression)",
     ylab = "Difference of Log2(Expression)",
     main = "MES13 RNA-Seq: HG vs. MIC_1_5_uM, No Zeros")
graphics.off()
